defmodule ClassificationUtility.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ClassificationUtility.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ClassificationUtility.ErrorHelpers.translate_error/1)
